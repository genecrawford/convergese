...
// MOBILE NAVIGATION SHOW AND HIDE LOGIC
$(function () {
    var $window = $(window);
    var $open = $("#mobile_open_link");
    var $close = $("#mobile_close_link");
    var $wrapper = $(".site_wrapper");

    $window.on("resize.mobile_nav", function (e) {
        $wrapper.removeClass("mobile_open");
    });
    $open.on("click.mobile_nav", function (e) {
        e.preventDefault();
        $wrapper.addClass("mobile_open");
    });
    $close.on("click.mobile_nav", function (e) {
        e.preventDefault();
        $wrapper.removeClass("mobile_open");
    });
});
